    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentions', models.ManyToManyField(related_name='mentioned_in_tweets', to=settings.AUTH_USER_MODEL)),
                ...
                ('views', models.ManyToManyField(related_name='viewed_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
